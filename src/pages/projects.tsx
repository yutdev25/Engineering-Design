...
const Projects = () => {
  ...
  const defaultProjects = [
    ...
    },
    {
      ...
      category: "Mechanical",
      images: "/project-fire-protection.jpg",
    ...
    },
    {
      ...
      category: "Mechanical",
      images: "/project-hvac-ductwork.jpg",
    ...
    },
    {
      ...
      category: "Electrical",
      images: "/project-electrical-layout.jpg",
    ...
    },
    {
      ...
      category: "Mechanical",
      images: "/project-water-supply.jpg",
    ...
    },
    {
      ...
      category: "Mechanical",
      images: "/project-chilled-water.jpg",
    ...
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-grow">
        ...
        <section className="py-16 bg-gray-50">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold text-gray-900">Technical Engineering Drawings</h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="bg-white rounded-lg shadow-lg overflow-hidden">
                ...
                />
                <div className="p-6">
                  <h3 className="text-xl font-semibold">Plumbing System 3D Model</h3>
              ...
              <div className="bg-white rounded-lg shadow-lg overflow-hidden">
                ...
                />
                <div className="p-6">
                  <h3 className="text-xl font-semibold">Fire Pump Room Design</h3>
                  <p className="mt-2 text-gray-600">
              ...
              <div className="bg-white rounded-lg shadow-lg overflow-hidden">
                ...
                />
                <div className="p-6">
                  <h3 className="text-xl font-semibold">Building Facade MEP Integration</h3>
                  <p className="mt-2 text-gray-600">
              ...
              <div className="bg-white rounded-lg shadow-lg overflow-hidden">
                ...
                />
                <div className="p-6">
                  <h3 className="text-xl font-semibold">Mechanical Room Layout</h3>
                  <p className="mt-2 text-gray-600">
        ...
        <section className="py-16 bg-gray-50">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold text-gray-900">Detailed Engineering Designs</h2>
              <p className="mt-4 max-w-2xl mx-auto text-xl text-gray-600">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="bg-white rounded-lg shadow-lg overflow-hidden">
                ...
                />
                <div className="p-6">
                  <h3 className="text-xl font-semibold">Chilled Water Piping Diagram</h3>
                  <p className="mt-2 text-gray-600">
              ...
              <div className="bg-white rounded-lg shadow-lg overflow-hidden">
                ...
                />
                <div className="p-6">
                  <h3 className="text-xl font-semibold">Electrical Distribution Layout</h3>
                  <p className="mt-2 text-gray-600">
              ...
              <div className="bg-white rounded-lg shadow-lg overflow-hidden">
                ...
                />
                <div className="p-6">
                  <h3 className="text-xl font-semibold">Fire Protection System Layout</h3>
                  <p className="mt-2 text-gray-600">
              ...
              <div className="bg-white rounded-lg shadow-lg overflow-hidden">
                ...
                />
                <div className="p-6">
                  <h3 className="text-xl font-semibold">Water Supply System Diagram</h3>
                  <p className="mt-2 text-gray-600">
